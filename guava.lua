...
game.StarterGui:SetCore(
    "SendNotification",
    {
        Title = "anh yêu em Hub",
        Text = "Đang Tải",
        Icon = "rbxthumb://type=Asset&id=72164408329767&w=150&h=150",
        Duration = 4
    })
------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------
...
local soundId = "rbxassetid://72164408329767" 
...
ImageButton.Image = "http://www.roblox.com/asset/?id=72164408329767"
...
Window:SelectTab(1)
Tabs.infor:AddSection("Nhóm Discord Của T<")
Tabs.infor:AddButton({
        Title = "conmemay  | Copy Link",
        Description = "conmemay ",
        Callback = function()
        setclipboard("E")
        end
    })
